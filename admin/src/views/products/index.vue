...
/** 加载门店选项；**失败不阻塞页面**（只是少一个筛选项，商品列表照常可用）。 */
async function loadShopOptions(): Promise<void> {
  try {
    shopOptions.value = await getEnabledShops(true)
  } catch {
    shopOptions.value = []
  }
}
